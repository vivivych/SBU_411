...
3. Написать программу, которая выводит на экран таблицу ASCII-символов по 16 в строке;
4. Вывести на экран ряд Фибоначчи до указанного предела. Предел вводит пользователь с клавиатуры;
